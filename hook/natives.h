...
namespace AUDIO
{
	...
	static Any _GET_CURRENT_RADIO_TRACK_PLAYBACK_TIME(char* p0) { return invoke<Any>(0x3E65CDE5215832C1, p0); } // chuj wie
	static char* GET_CURRENT_TRACK_SOUND_NAME(char* p0) { return invoke<char*>(0x34D66BC058019CE0, p0); } // chuj wie
